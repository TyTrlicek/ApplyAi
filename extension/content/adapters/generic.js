...
AA.adapters.generic = {
  ...
  detectJobContext() {
    ...
    if (!ctx.description) {
      const main =
        document.querySelector('[class*="job-description"],[class*="posting-description"],[data-testid*="description"],main article,main');
  ...
  // Something to fill: at least a few labelled controls including an email or
  // name field, or a visible file input.
  isApplicationForm() {
