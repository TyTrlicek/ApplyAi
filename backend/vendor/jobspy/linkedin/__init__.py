    ...
    def scrape(self, scraper_input: ScraperInput) -> JobResponse:
        ...
        while continue_search():
            ...
            params = {
                ...
                "pageNum": 0,
                "start": start,
                "f_E": (  # ApplyAi: LinkedIn experience-level filter (server-side)
                    ",".join(map(str, scraper_input.linkedin_experience_level))
                    if scraper_input.linkedin_experience_level
                    else None
                ),
