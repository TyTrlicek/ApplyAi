...
def scrape_jobs(
    ...
    linkedin_experience_level: list[int] | None = None,  # ApplyAi: f_E filter (1=intern,2=entry,3=associate,...)
    offset: int | None = 0,
    hours_old: int = None,
    ...
    **kwargs,
    ...
    scraper_input = ScraperInput(
        ...
        linkedin_experience_level=linkedin_experience_level,  # ApplyAi
        offset=offset,
        hours_old=hours_old,
    )
